/**
 * Shared types for the VPS sandbox/deployment agent.
 *
 * These types are used by both the Next.js app (VpsProvider client) and the
 * vps-agent service. Keep this file free of Next.js or Node-only imports so it
